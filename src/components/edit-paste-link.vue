...
export default class extends Vue {  
  ...
  edit() {
    console.info('Resetting and copying paste')
    globalStore.PasteEditing.reset()
    Object.assign(globalStore.PasteEditing.paste, this.paste);
    (this as any).$router.push('/paste/edit')
  }
}
